...
entity edi856_idoc_errors {
    ...
    key counter             : Integer;     // EDIDS-COUNTER (status line sequence within the IDoc)
        ...
        // Correlation keys used to link back to business data / exception rules
        po_number           : String(10);
        line_item           : String(5);
        ...
        idoc_credat         : Date;      // EDIDC-CREDAT, IDoc creation date
        idoc_cretim         : Time;      // EDIDC-CRETIM
        status_logdat       : Date;      // EDIDS-LOGDAT
        status_logtim       : Time;      // EDIDS-LOGTIM
